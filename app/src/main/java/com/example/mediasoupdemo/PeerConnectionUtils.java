...
public class PeerConnectionUtils {
        ...
        JavaAudioDeviceModule.AudioTrackErrorCallback audioTrackErrorCallback =
                new JavaAudioDeviceModule.AudioTrackErrorCallback() {
                    ...
                    public void onWebRtcAudioTrackInitError(String errorMessage) {
                        android.util.Log.e(TAG, "onWebRtcAudioTrackInitError: " + errorMessage);
                    }

                    @Override
                    public void onWebRtcAudioTrackStartError(
                            JavaAudioDeviceModule.AudioTrackStartErrorCode errorCode, String errorMessage) {
                        android.util.Log.e(TAG, "onWebRtcAudioTrackStartError: " + errorCode + ". " + errorMessage);
                    }

                    @Override
                    public void onWebRtcAudioTrackError(String errorMessage) {
                        android.util.Log.e(TAG, "onWebRtcAudioTrackError: " + errorMessage);
                    }
                };
    ...
    public void changeToCustom(int width, int height) {
        if (mCamCapture != null) {
            mCamCapture.changeCaptureFormat(width, height, 30);
        }
    }
